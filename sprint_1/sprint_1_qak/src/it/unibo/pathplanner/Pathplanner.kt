		...
		return { //this:ActionBasciFsm
				...
				state("dummy_wait_build") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t011",targetState="readMap",cond=whenReply("mapCreated"))
				}	 
				...
				state("accepting") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t012",targetState="findAPath",cond=whenRequest("destination"))
				}	 
				state("findAPath") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t013",targetState="pathok",cond=whenReply("dopathdone"))
					transition(edgeName="t014",targetState="pathko",cond=whenReply("dopathfail"))
				}	 
