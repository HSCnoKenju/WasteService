		...
		return { //this:ActionBasciFsm
				...
				state("accepting") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t015",targetState="processRequest",cond=whenRequest("buildMap"))
				}	 
				...
				state("doAheadMove") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t016",targetState="continue",cond=whenReply("stepdone"))
					transition(edgeName="t017",targetState="turn",cond=whenReply("stepfail"))
				}	 
