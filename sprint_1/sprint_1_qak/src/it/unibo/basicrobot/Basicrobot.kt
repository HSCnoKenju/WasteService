		...
		return { //this:ActionBasciFsm
				...
				state("work") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t15",targetState="execcmd",cond=whenDispatch("cmd"))
					transition(edgeName="t16",targetState="doStep",cond=whenRequest("step"))
					transition(edgeName="t17",targetState="handleObstacle",cond=whenDispatch("obstacle"))
					transition(edgeName="t18",targetState="endwork",cond=whenDispatch("end"))
				}	 
				...
				state("doStep") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t09",targetState="stepDone",cond=whenTimeout("local_tout_basicrobot_doStep"))   
					transition(edgeName="t010",targetState="stepFail",cond=whenDispatch("obstacle"))
				}	 
