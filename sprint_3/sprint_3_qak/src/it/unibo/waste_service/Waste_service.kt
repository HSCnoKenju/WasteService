		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t133",targetState="getWeights",cond=whenDispatch("init_capacity"))
				}	 
				...
				state("accepting") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t034",targetState="check_availability",cond=whenRequest("waste"))
					transition(edgeName="t035",targetState="reset_weights",cond=whenDispatch("reset"))
				}	 
				...
				state("issue_trolley") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t136",targetState="lost_pickup",cond=whenReply("workdone"))
					transition(edgeName="t137",targetState="updateWeights",cond=whenEvent("pickup"))
				}	 
				...
				state("acceptBusy") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t238",targetState="accepting",cond=whenReply("workdone"))
					transition(edgeName="t239",targetState="checkWhenBusy",cond=whenRequest("waste"))
					transition(edgeName="t240",targetState="reset_weightsBusy",cond=whenDispatch("reset"))
				}	 
