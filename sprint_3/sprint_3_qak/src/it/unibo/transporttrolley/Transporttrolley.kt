		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t124",targetState="gotPositions",cond=whenDispatch("all_position"))
				}	 
				...
				state("accepting") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t025",targetState="goingIndoor",cond=whenRequest("goal"))
				}	 
				state("goingIndoor") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t126",targetState="arriveIndoor",cond=whenReply("arrived"))
				}	 
				state("arriveIndoor") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t127",targetState="arriveContainer",cond=whenReply("arrived"))
				}	 
				state("arriveContainer") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t128",targetState="goingHome",cond=whenTimeout("local_tout_transporttrolley_arriveContainer"))   
					transition(edgeName="t129",targetState="goingIndoor",cond=whenRequest("goal"))
				}	 
				state("goingHome") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t130",targetState="arriveHome",cond=whenReply("arrived"))
				}	 
