		...
		return { //this:ActionBasciFsm
				...
				state("work") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t111",targetState="execcmd",cond=whenDispatch("cmd"))
					transition(edgeName="t112",targetState="doStep",cond=whenRequest("step"))
					transition(edgeName="t113",targetState="handleObstacle",cond=whenDispatch("obstacle"))
					transition(edgeName="t114",targetState="endwork",cond=whenDispatch("end"))
				}	 
				...
				state("doStep") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t015",targetState="stepDone",cond=whenTimeout("local_tout_basicrobot_doStep"))   
					transition(edgeName="t016",targetState="stepFail",cond=whenDispatch("obstacle"))
				}	 
