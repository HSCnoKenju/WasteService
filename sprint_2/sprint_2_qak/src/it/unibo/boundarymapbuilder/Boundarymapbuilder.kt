		...
		return { //this:ActionBasciFsm
				...
				state("accepting") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t020",targetState="processRequest",cond=whenRequest("buildMap"))
				}	 
				...
				state("doAheadMove") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t021",targetState="continue",cond=whenReply("stepdone"))
					transition(edgeName="t022",targetState="turn",cond=whenReply("stepfail"))
				}	 
