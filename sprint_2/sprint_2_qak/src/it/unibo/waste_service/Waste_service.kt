		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t132",targetState="getWeights",cond=whenDispatch("init_capacity"))
				}	 
				...
				state("accepting") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t033",targetState="check_availability",cond=whenRequest("waste"))
					transition(edgeName="t034",targetState="reset_weights",cond=whenDispatch("reset"))
				}	 
				...
				state("issue_trolley") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t135",targetState="lost_pickup",cond=whenReply("workdone"))
					transition(edgeName="t136",targetState="updateWeights",cond=whenEvent("pickup"))
				}	 
				...
				state("acceptBusy") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t237",targetState="accepting",cond=whenReply("workdone"))
					transition(edgeName="t238",targetState="checkWhenBusy",cond=whenRequest("waste"))
					transition(edgeName="t239",targetState="reset_weightsBusy",cond=whenDispatch("reset"))
				}	 
