		...
		return { //this:ActionBasciFsm
				...
				state("work") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t110",targetState="execcmd",cond=whenDispatch("cmd"))
					transition(edgeName="t111",targetState="doStep",cond=whenRequest("step"))
					transition(edgeName="t112",targetState="handleObstacle",cond=whenDispatch("obstacle"))
					transition(edgeName="t113",targetState="endwork",cond=whenDispatch("end"))
				}	 
				...
				state("doStep") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t014",targetState="stepDone",cond=whenTimeout("local_tout_basicrobot_doStep"))   
					transition(edgeName="t015",targetState="stepFail",cond=whenDispatch("obstacle"))
				}	 
