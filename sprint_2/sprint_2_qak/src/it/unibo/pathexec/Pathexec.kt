		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t03",targetState="doThePath",cond=whenRequest("dopath"))
				}	 
				...
				state("doMoveTurn") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t04",targetState="nextMove",cond=whenTimeout("local_tout_pathexec_doMoveTurn"))   
				}	 
				state("doMoveW") { //this:State
					...
					transition(edgeName="t08",targetState="stopState",cond=whenEvent("stop"))
				}	 
				...
				state("stopState") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="to9",targetState="doMoveW",cond=whenEvent("resume"))
				}	 
			}
		}
}
