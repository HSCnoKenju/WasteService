		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t112",targetState="getWeights",cond=whenDispatch("init_capacity"))
				}	 
				...
				state("accepting") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t013",targetState="check_availability",cond=whenRequest("waste"))
					transition(edgeName="t014",targetState="reset_weights",cond=whenDispatch("reset"))
					transition(edgeName="t015",targetState="lost_pickup",cond=whenReply("workdone"))
					transition(edgeName="t016",targetState="updateWeights",cond=whenEvent("pickup"))
				}	 
				state("reset_weights") { //this:State
					action { //it:State
						...
						updateResourceRep("weights(Glass=$Available_Glass Plastic=$Available_Plastic)" 
						)
						//genTimer( actor, state )
					}
					//After Lenzi Aug2002
				...
				state("issue_trolley") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t117",targetState="lost_pickup",cond=whenReply("workdone"))
					transition(edgeName="t118",targetState="updateWeights",cond=whenEvent("pickup"))
				}	 
				...
				state("acceptBusy") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t219",targetState="accepting",cond=whenReply("workdone"))
					transition(edgeName="t220",targetState="checkWhenBusy",cond=whenRequest("waste"))
					transition(edgeName="t221",targetState="reset_weightsBusy",cond=whenDispatch("reset"))
				}	 
