	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					transition(edgeName="t17",targetState="handleEnvSonar",cond=whenEvent("sonardata"))
				}	 
				...
				state("handleEnvSonar") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t18",targetState="handleEnvSonar",cond=whenEvent("sonardata"))
				}	 
			}
		}
}
